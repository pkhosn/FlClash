              ...
              child: Row(
                children: [
                  ...
                  Column(
                    ...
                    children: const [
                      Text('重要更新通知', style: V2ETTokens.h3),
                      SizedBox(height: 2),
                      Text('第 1 条，共 5 条', style: V2ETTokens.small),
                    ],
                  ),
                  const Spacer(),
                  IconButton(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 18),
                    Text(
                      '您好 v2et 已经上线全新客户端, Windows 和安卓 没有收到自动更新提示的, 进入官网下载 shizi.pro 自行下载更新, 如果 mac 需要更新可以联系客服发送安装包. 已更新请忽略.',
                      style: TextStyle(
                        fontSize: 14,
                        height: 1.9,

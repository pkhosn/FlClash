            ...
            children: [
              ...
              if (!loading)
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        const Text('邀请链接', style: V2ETTokens.h3),
                        const Spacer(),
                        V2ETButton(
                          label: '创建邀请码',
              ...
              if (!loading)
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('佣金历史', style: V2ETTokens.h3),
                    const Spacer(),
                    Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10),
                          const Text('暂无佣金记录', style: V2ETTokens.small),
                        ],
                      ),
                    ),
                    const Spacer(),
...
class _InviteMetric extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    children: [
      Icon(icon, color: V2ETTokens.primary, size: 28),
      const SizedBox(height: 10),
      Text(
        value,
        style: const TextStyle(
